import { treeDatabase, TreeDatabase } from '../../../database';
import { arrayEach, isObject, objectEach, objectKeys, objectMerge, objectUpdate, typeSwitch } from '@presource/core';
...
export const stringStyled: Structure = (input, resolvers) => {
    ...
    const styles = input.split(' ').map((value) => stringStyledEach(value, resolvers));
