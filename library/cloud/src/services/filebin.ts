import { RestServiceResponseBody } from './classes';
...
// Filebin requires proxy for it to work, due to CORS issue.
// Preferably, we shouldn't have CORS issue.
